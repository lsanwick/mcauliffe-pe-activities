...
[![Netlify Status](https://api.netlify.com/api/v1/badges/060c78db-6fce-4222-8639-88da0318e439/deploy-status)](https://app.netlify.com/sites/elated-rosalind-2a3605/deploys)

This blog is statically generated by [Hugo](https://gohugo.io/). It is preconfigured to work with [Forestry](https://forestry.io/) as a way to manage your content. Forestry makes changes by editing markdown or data files, uploading media to the correct directory and committing these updates to your repo directly.
...
```bash
#clone the repo
git clone git@github.com:lsanwick/mcauliffe-pe-activities

#navigate to the directory
cd mcauliffe-pe-activities
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/lsanwick/mcauliffe-pe-activities)
